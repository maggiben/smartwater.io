...
void cdmHelp(SerialCommands *sende);
void cmdGetActiveAlarm(SerialCommands *sende);
void cmdSetActiveAlarms(SerialCommands *sende);
void cmdToggleActiveAlarms(SerialCommands *sende);
...
SerialCommand cmdSetTimeAndDate_("tm", cmdSetTimeAndDate);
SerialCommand cmdGetAlarms_("al", cmdGetAlarms);
SerialCommand cmdResetAlarms_("ra", cmdResetAlarms);
SerialCommand cmdReboot_("rb", cmdReboot);
SerialCommand cmdGetActiveAlarms_("as", cmdGetActiveAlarms);
SerialCommand cmdGetActiveAlarm_("aa", cmdGetActiveAlarm);
SerialCommand cmdSetActiveAlarms_("sa", cmdSetActiveAlarms);
SerialCommand cmdToggleActiveAlarms_("ta", cmdToggleActiveAlarms);
SerialCommand cmdTestPump_("tp", cmdTestPump);
SerialCommand cmdGetAlarmsX_("ga", cmdGetAlarms);
